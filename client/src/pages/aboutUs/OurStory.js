    ...
    <div className={styles.ourStorycontainer}>
      ...
      <section className={styles.ourStoryInfo}>
        ...
        <p className={styles.ourStoryInfoSubtitle}>
          Founded in 2010, Dream Homes was built on a simple yet powerful idea:
          to make the process of buying and selling homes a joyful and
        ...
        <p className={styles.ourStoryInfoSubtitle}>
          ...
          building lasting relationships, embracing innovation, and consistently
          exceeding expectations. We are proud of our history and excited for
          the future we are building, one dream home at a time.
        </p>
      </section>
    </div>
  );
